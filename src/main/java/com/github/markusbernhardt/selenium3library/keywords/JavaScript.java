...
public class JavaScript extends RunOnFailureKeywordsAdapter {
	...
	public void alertShouldBePresent(String text) {
		...
		if (text != null && !alertText.equals(text)) {
			throw new Selenium3LibraryNonFatalException(String.format("Alert text should have been '%s' but was '%s'",
					text, alertText));
		}
	}
	...
	public String confirmAction() {
		try {
			...
			throw new Selenium3LibraryNonFatalException("There were no alerts");
		}
	}
	...
	protected String getJavascriptToExecute(String code) {
		...
		try {
			...
			throw new Selenium3LibraryNonFatalException("Cannot read JavaScript file: " + codepath);
		}
	}
