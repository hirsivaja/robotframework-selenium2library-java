...
import com.github.markusbernhardt.selenium3library.keywords.BrowserManagement;
import com.github.markusbernhardt.selenium3library.keywords.Cookie;
import com.github.markusbernhardt.selenium3library.keywords.Element;
import com.github.markusbernhardt.selenium3library.keywords.FormElement;
import com.github.markusbernhardt.selenium3library.keywords.JavaScript;
import com.github.markusbernhardt.selenium3library.keywords.Logging;
import com.github.markusbernhardt.selenium3library.keywords.RunOnFailure;
import com.github.markusbernhardt.selenium3library.keywords.Screenshot;
import com.github.markusbernhardt.selenium3library.keywords.SelectElement;
import com.github.markusbernhardt.selenium3library.keywords.TableElement;
import com.github.markusbernhardt.selenium3library.keywords.Waiting;
import com.github.markusbernhardt.selenium3library.utils.Javadoc2Libdoc;

/**
 * Selenium3Library is a web testing library for the Robot Framework and was
 ...
 * Prior to running test cases using Selenium3Library, the library must be
 ...
 * All keywords in Selenium3Library that need to find an element on the page
 ...
 * It is also possible to specify the approach Selenium3Library should take to
 ...
 * </table>
 */
public class Selenium3Library extends AnnotationLibrary {

	/**
	 * The list of keyword patterns for the AnnotationLibrary
	 */
	public static final String KEYWORD_PATTERN = "com/github/markusbernhardt/selenium3library/keywords/**/*.class";

	/**
	 * The javadoc to libdoc converter
	 */
	public static final Javadoc2Libdoc JAVADOC_2_LIBDOC = new Javadoc2Libdoc(Selenium3Library.class);
	...
	private static String loadRobotLibraryVersion() {
		try {
			return ResourceBundle.getBundle(Selenium3Library.class.getCanonicalName().replace(".", File.separator))
					.getString("version");
	...
	public Selenium3Library() {
		this("5.0");
	}

	public Selenium3Library(String timeout) {
		this(timeout, "0.0");
	}

	public Selenium3Library(String timeout, String implicitWait) {
		this(timeout, implicitWait, "Capture Page Screenshot");
	}

	/**
	 * Selenium3Library can be imported with optional arguments.<br>
	 * <br>
	 ...
	 * libraries) to execute when a Selenium3Library keyword fails. By default
	 ...
	 *            run on failure.
	 */
	public Selenium3Library(String timeout, String implicitWait, String keywordToRunOnFailure) {
		super();
	...
	/**
	 * Returns the currently active Selenium3Library instance.
	 * 
	 * @return the library instance
	 * @throws ScriptException - if error occurs in script
	 */
	public static Selenium3Library getLibraryInstance() throws ScriptException {
		ScriptEngine engine = new ScriptEngineManager().getEngineByName("python");
		engine.put("library", "Selenium3Library");
		engine.eval("from robot.libraries.BuiltIn import BuiltIn");
		engine.eval("instance = BuiltIn().get_library_instance(library)");
		return (Selenium3Library) engine.get("instance");
	}
