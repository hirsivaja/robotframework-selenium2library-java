package com.github.markusbernhardt.selenium3library.locators;
...
public class ElementFinder {
	...
	public static List<WebElement> find(WebDriver webDriver, String locator, String tag) {
		if (webDriver == null) {
			throw new Selenium3LibraryNonFatalException("ElementFinder.find: webDriver is null.");
		}
		if (locator == null) {
			throw new Selenium3LibraryNonFatalException("ElementFinder.find: locator is null.");
		}
